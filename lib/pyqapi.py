#!/usr/bin/python
# -*- coding: utf-8 -*-
# found here: https://code.google.com/p/python-weather-api/
            ...
            for part in forecast.getElementsByTagName('part'):
                ...
                for tag2 in ('s', 'gust', 'd', 't'):            
                    ...
                    try:
                        ...
                        tmp_forecast[time_of_day]['wind'][key2] = "NA"
...
def heat_index(temperature, humidity, units = 'metric'):
    ...
    Fahrenheit, to within Â±1.3 Â°F. It is the result of a
    multivariate fit (temperature equal to or greater than
    80Â°F and relative humidity equal to or greater than 40%)
    ...
    Returns:
      heat_index: a numerical value representing the heat index
        ...
        Returns None if the specified temperature is less than 80Â°F
    ...
    # Heat Index is only valid for temp >= 80Â°F and humidity >= 40%)
    if (R < 40.0 or T < 80.0):
        return None
...
if __name__ == "__main__":
    ...
    ID_code = get_loc_id_from_weather_com("Regensburg")
    #print(ID_code)
    if ID_code['count'] == 1:
        weather_com_result = get_weather_from_weather_com(ID_code[0][0]) #GMXX0223
        ...
        print "Weather.com says: It is " + string.lower(weather_com_result['current_conditions']['text']) + \
          ...
          "C now in " + weather_com_result['current_conditions']['station'].split(",")[0] + "is icon" + \
        weather_com_result["current_conditions"]["icon"]
